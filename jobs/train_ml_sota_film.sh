...
# ==============================================================================
# MM-TGN Training: MovieLens SOTA + FiLM Fusion
# Experiment: FiLM fusion (text modulates image via γ⊙x + β)
# ==============================================================================

echo "🚀 MM-TGN Training: ML-Modern SOTA + FiLM Fusion"
echo "Date: $(date)"
echo "Node: $(hostname)"
echo ""
